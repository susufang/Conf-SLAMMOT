...
The above figure show the visualization results of different methods in continuous missed detection scenes. (1a-1d), (2a-2d), (3a-3d) represent the results of LIO-SEGMOT at consecutive moments on sequences 00, 02 of KITTI Tracking dataset, and an intersection scene of Waymo Perception dataset, respectively; (1a*-1d*), (2a*-2d*), (3a*-3d*) represent the results of the proposed Conf SLAMMOT at consecutive moments on corresponding scenes, respectively. Due to temporary occlusion or distance of objects, there are continuous frame missed detection; these objects are highlighted and enlarged with circles for display. For example, object ID 0 in (1b*-1c*) and object ID 52 in (3b*-3c*), and as shown in (1d*) and (3d*), Conf SLAMMOT can accurately resume tracking without ID switching.
